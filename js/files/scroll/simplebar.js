(() => {
    ...
    (() => {
        ...
        const simpleBarInstance = new simplebar_esm(document.querySelector(".select__body"));
        ...
        simpleBarElement.addEventListener("scroll", (function() {
            ...
            if (scrollTop + clientHeight >= scrollHeight - 10) document.documentElement.classList.add("select-scroll"); else document.documentElement.classList.remove("select-scroll");
        }));
    })();
})();